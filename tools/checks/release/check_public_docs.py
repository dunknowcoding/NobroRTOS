...
DOC_REFERENCE_EXEMPT = {
    pathlib.PurePosixPath("tools/checks/release/check_public_docs.py"),
    pathlib.PurePosixPath("tools/checks/release/check_release_boundary.py"),
}
PRIVATE = {
