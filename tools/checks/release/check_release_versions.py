...
guarantees the artifacts agree with each other.
    ...
    python tools/checks/release/check_release_versions.py             # equality check (CI gate)
    python tools/checks/release/check_release_versions.py --release   # also refuse -dev/0.0.0
"""
import argparse
import json
import re
