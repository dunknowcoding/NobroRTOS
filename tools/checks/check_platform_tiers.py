...
composition, and CI runners must submit all of their required gate receipts.
    ...
    python tools/checks/check_platform_tiers.py
    python tools/checks/check_platform_tiers.py --selftest
    python tools/checks/check_platform_tiers.py --begin-receipts RUNNER
    python tools/checks/check_platform_tiers.py --run-gate GATE
    python tools/checks/check_platform_tiers.py --assert-receipts RUNNER
