...
gate "resource baselines (RES-01 sizes vs budgets)"   bash -c 'python tools/measure_baselines.py > _work/baselines_gate.log 2>&1 || { cat _work/baselines_gate.log; exit 1; }' 
