...
nobro-min from the internal comparison budget file.

    python tools/internal/comparison/measure_baselines.py --selftest
...
BUDGETS = pathlib.Path(__file__).with_name("baseline_budgets.json")
