...
| Board connectivity adapters | In progress | Portable WiFi/BLE contracts are present; UNO R4 WiFiS3 is compile-only, while pinned Arduino-ESP32 WiFi has C3 zero-disabled and physical association/DNS/TCP/lifecycle evidence but remains unpriced |
