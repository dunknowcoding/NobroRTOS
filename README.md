...
| Board connectivity adapters | In progress | Portable WiFi/BLE contracts are present; UNO R4 WiFiS3 is compile-only, while one pinned Arduino-ESP32 C3 station workload has zero-disabled, physical lifecycle, and complete configuration-price evidence |
