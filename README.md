...
| Board connectivity adapters | In progress | Portable WiFi/BLE contracts are present; UNO R4 WiFiS3 and pinned Arduino-ESP32 WiFi have compile-only, zero-disabled association facades while physical traffic and resource pricing remain gated |
