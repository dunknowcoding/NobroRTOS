...
| [05 — Rust Deep Dive](05-rust-deep-dive/README.md) | pros 🦀 | the Rust toolchain | backend-swapped drivers, budgets, and evidence packs |
...
Maintainers: `python tools/tutorial_runner.py` gates this ladder in CI.
