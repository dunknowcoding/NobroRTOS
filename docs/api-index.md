...
- **struct**: `AdapterDescriptor`, `AdapterCompatibilityReport`, `AdapterSet`, `AdapterPreflight`, `ImuSample`, `RosTopicContract`, `RosServiceContract`, `RosActionContract`, `RosParameterContract`, `RosBridgeContract`, `RosBridgePreflight`, `RosBridgeContractReport`, `AiRuntimeState`, `AiRouteDecision`, `AiRoutePolicy`, `ModelRegistry`, `AiModelContract`, `AiModelContractReport`, `AiInferenceRequest`, `AiInferenceResult`, `AiInvocationLimits`, `AiInvocationPreflight`
