...
| PlatformIO Arduino project | `lib_deps = dunknowcoding/NobroRTOS@^0.3.3` | The same checked C/C++ facade in a self-contained registry archive |
...
board = uno
framework = arduino
lib_deps = dunknowcoding/NobroRTOS@^0.3.3
