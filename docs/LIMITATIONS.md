...
| --- | --- | --- | --- |
| Deep | nRF52840, RA4M1, SAMD21 | Exact native profiles satisfy their declared target-build contracts. RA4M1 includes sleep-stable AGT time/deadline, GPT2/ELC capture, bounded ADC/PWM/I2C/SPI/UART, USBFS, reset/CPU-sleep, leases, and opt-in event-paced DMAC completion. SAMD21 includes RTC/TC4, EIC/EVSYS/DMAC, TCC PWM, SERCOM UART/I2C/SPI, USB CDC, reset/CPU-sleep, leases, and an exact Arduino Zero-compatible dual-PN532 composition | Exact UNO R4 evidence covers time/deadline status, event-DMAC cancellation/completion/sleep-wake, USBFS enumeration/reconnect, native D5/GPT0-A PWM-to-A0/ADC9 loopback, the separate Arduino RC522 composition, WiFiS3 recovery, and exact restoration. RA4M1 native I2C/SPI remain non-physical; deep standby, servo, watchdog, RTC, flash, GPIO, and generic IRQ providers are not claimed there. SAMD21 remains target-build only until its native image, dual PN532 paths, IRQ route, recovery, and restoration pass physically |
