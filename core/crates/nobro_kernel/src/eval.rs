//! Phase 1 evaluation thresholds and bench gate logic.

/// Minimum TIMER1 ticks before scene A can pass (~3 s @ 50 Hz).
pub const MIN_DEADLINE_TICKS: u32 = 150;

/// Max allowed deadline jitter in microseconds for the resource scheduling scene.
...
pub const EVAL_MAGIC: u32 = 0x4E42_4E31; // "NB1"
pub const EVAL_VERSION: u32 = 1;

/// Fixed-layout report read by host tools through the NobroRTOS host contract.
#[repr(C)]
...
pub const SAL_EVAL_MAGIC: u32 = 0x4E42_4E32; // "NB2"
...
/// Phase 2 SAL adapter fixture report.
#[repr(C)]
#[derive(Clone, Copy, Debug, Default)]
