...
//!
//! RP2350 has one more PIO block than RP2040, but the instruction and FIFO
//! contract is shared. This check installs a program on PIO0/SM0, observes its
//! live output word, then releases the state machine and instruction memory.
