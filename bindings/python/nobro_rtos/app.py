...
_BOARDS = {
    "nano-v3-atmega328p": ("atmega328p", 16_384, 1_024),
    "esp-wroom32-30pin": ("esp32", 131_072, 49_152),
    "esp32-cam-ov2640": ("esp32", 131_072, 49_152),
    "esp32c3-supermini": ("esp32c3", 131_072, 65_536),
    "esp32p4-pico": ("esp32p4", 262_144, 131_072),
    "esp32s3-cam-ov5640": ("esp32s3", 131_072, 65_536),
    "esp32s3-uno": ("esp32s3", 131_072, 65_536),
    "xiao-esp32s3-sense": ("esp32s3", 131_072, 65_536),
    "wemos-d1-mini": ("esp8266", 524_288, 32_768),
    "nrf52840-s140": ("nrf52840", 81_920, 32_768),
    "nrf52840-nosd": ("nrf52840", 81_920, 32_768),
    "uno-r4-wifi": ("ra4m1", 98_304, 16_384),
    "rp2040-pico": ("rp2040", 65_536, 32_768),
    "rp2350-pico2w": ("rp2350", 131_072, 65_536),
    "samd21-m0-mini": ("samd21", 49_152, 12_288),
    "samd21-uf2": ("samd21", 49_152, 12_288),
}
_ROLES = {
