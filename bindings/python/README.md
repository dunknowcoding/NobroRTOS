...
```powershell
python sdk/cli/nobro.py contract decode-boot 0x04040003
```

Validate a contract bundle JSON file:

```powershell
python sdk/cli/nobro.py contract validate-bundle path\to\bundle.json
```

Decode a report JSON file:

```powershell
python sdk/cli/nobro.py contract decode-report manifest path\to\manifest_report.json
python sdk/cli/nobro.py contract decode-report adapter_compatibility path\to\adapter_report.json
python sdk/cli/nobro.py contract decode-report board_package path\to\board_package_report.json
python sdk/cli/nobro.py contract decode-report admission path\to\admission_report.json
python sdk/cli/nobro.py contract decode-report runtime path\to\runtime_report.json
python sdk/cli/nobro.py contract decode-report health path\to\health_report.json
python sdk/cli/nobro.py contract decode-report event_log path\to\event_log_report.json
python sdk/cli/nobro.py contract decode-report module_runtime path\to\module_runtime_report.json
python sdk/cli/nobro.py contract decode-report degrade_application path\to\degrade_report.json
python sdk/cli/nobro.py contract decode-report ai_model path\to\ai_model_report.json
python sdk/cli/nobro.py contract decode-report ros_bridge path\to\ros_bridge_report.json
```
...
```powershell
python sdk/cli/nobro.py contract summarize-boot path\to\boot_reports.json
```
