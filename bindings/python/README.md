...
the Python board bridge template includes an offline bridge smoke task for
...
deadline jitter counters for timing-policy checks. The event-log sample emits
...
and runtime drill gates into one JSON report.
